...
const arr_prof = [
 ...
 },
 {
  logo: `<svg
             ...
             >`,
  label: "Interests",
  value: "Design Graphics, Photography, IoT Project",
 },
 {
  logo: `<svg
              xmlns="http://www.w3.org/2000/svg"
             ...
             >`,
  label: "Study",
  value: "Indonesian Education University",
 },
 {
  logo: `<svg
              xmlns="http://www.w3.org/2000/svg"
...
for (let i = 0;i < arr_prof.length;i++) {
  const li = document.createElement("li");
  li.className = "col-span-1 flex items-start gap-x-2";
  li.innerHTML = `
  ${arr_prof[i].logo}
  <span class="text-xs font-bold text-white sm:text-sm">${arr_prof[i].label}:</span>
  <span class="text-xs text-gray-200 sm:text-sm">${arr_prof[i].value}</span>
  `;
